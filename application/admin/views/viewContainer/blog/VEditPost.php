                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea  class="form-control"  required="" name="meta" id="meta"> <?php echo $row["meta"]; ?></textarea>
                                    
                                </div>
                                <div class="form-group">
                                    <label>Meta Keyword</label>
                                    <textarea  class="form-control"  required="" name="keyword" id="meta"> <?php echo $row["keyword"]; ?></textarea>
...
//        edit.getDoc().setValue(value);
                            ...
                            //CKEDITOE.config.allowedContent = true;
