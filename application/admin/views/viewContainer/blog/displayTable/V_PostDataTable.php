...
<!--                            <td>
                                ...
                                <a href="/?r=<?php echo $obj->encdata("C_OpenLink2") . "&v=" . $obj->encdata("VAddMoreURL") . "&id=" . $row["id"]; ?>" onclick=" return postURL2('<?php echo $obj->encdata("C_OpenLink2") . "&v=" . $obj->encdata("VAddMoreURL"); ?>', '#main', '<?php echo $row["id"]; ?>')" class="btn btn-default btn-xs"><i class="fa fa-pencil-square-o"></i></a>
