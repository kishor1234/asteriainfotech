            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            <a href="#"><i class="fa fa-asterisk"></i> <span>Menu</span> <i class="fa fa-angle-left pull-right"></i></a>
                            <ul class="treeview-menu">
                        ...
                        <li class="treeview">
                            <a href="#"><i class="fa fa-link"></i> <span>Prise</span> <i class="fa fa-angle-left pull-right"></i></a>
                            <ul class="treeview-menu">
                        ...
                        <li class="treeview">
                            <a href="#"><i class="fa fa-asterisk"></i> <span>Blogs Post's</span> <i class="fa fa-angle-left pull-right"></i></a>
                            <ul class="treeview-menu">
