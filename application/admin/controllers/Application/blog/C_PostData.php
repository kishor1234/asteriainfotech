    ...
    public function initialize() {
        ...
        try {
            ...
            if (!empty($_FILES)) {
                ...
                $data = array("banner_path" => $path2, "banner_url" => $filename2, "branch" => $this->filterPost("branch"), "title" => $this->filterPost("title"), "meta" => $this->filterPost("meta"),"description" => $this->filterPost("txtEditor"),"keyword"=>$this->filterPost("keyword"), "img" => $filename, "path" => $path, "category" => $this->filterPost("category"), "byw" => "Admin", "ip" => $_SERVER["REMOTE_ADDR"]);
                ...
                $_SESSION["msg"] = $this->printMessage("Success...! #" . $post_id, "success");
            } else {
